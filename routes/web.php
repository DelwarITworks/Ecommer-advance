...
Route::post('/create/contact', 'PublicController@contactCreate')->name('create.contact');
Route::post('/create/subscriber', 'PublicController@subscriberCreate')->name('create.subscriber');
